    ...
    return (
      <div className="error__message-container">
        <p className="error__message">
          Apologies, an error occurred while processing your request. This could
          be due to a connectivity problem or server unavailability. Kindly
          attempt your request later or navigate back to the main page and retry
          again.
        </p>
      </div>
    );
